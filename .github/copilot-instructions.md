...
- **Never hardcode anything unless absolutely required**: Avoid hardcoding values like URLs, API endpoints, configuration settings, or constants directly in code. Use environment variables, configuration files, or constants modules instead to ensure flexibility and maintainability.
